...
[Scope]
public class ChatDeletionIntegrationEventHandler(
    ILogger<ChatDeletionIntegrationEventHandler> logger,
    TenantManager tenantManager,
    ChatDeletionTaskQueue chatDeletionTaskQueue,
    IServiceProvider serviceProvider)
    : IIntegrationEventHandler<ChatDeletionIntegrationEvent>
{
    public async Task Handle(ChatDeletionIntegrationEvent @event)
    {
