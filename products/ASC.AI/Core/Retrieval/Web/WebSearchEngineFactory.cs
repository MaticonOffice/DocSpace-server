...
{
    public IWebSearchEngine Create(EngineConfig config, Dictionary<string, string>? metadata)
    {
        // CA2000: HttpClient ownership transferred to search engine instances
#pragma warning disable CA2000
        return config switch
        {
            InternalWebSearchConfig docSpaceConfig => new InternalWebSearchEngine(
