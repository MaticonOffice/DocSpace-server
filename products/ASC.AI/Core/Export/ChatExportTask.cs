...
[Transient]
public class ChatExportTask(IServiceScopeFactory serviceScopeFactory)
    : ExportTask<ChatExportTaskData>(serviceScopeFactory)
{
    protected override async IAsyncEnumerable<Message> GetMessages(IServiceProvider serviceProvider)
    {
        ...
        await foreach (var message in chatDao.GetMessagesAsync(Data.ChatId))
        {
