...
public class OpenAiResponsesClient(IChatClient innerClient) : IChatClient
{
    ...
    private static ChatOptions? ConfigureOptions(ChatOptions? options)
    {
        ...
        options.RawRepresentationFactory = client =>
        {
            ...
            responseOptions.Patch.Set("$.reasoning"u8, JsonSerializer.SerializeToUtf8Bytes(new { effort = "none" }));
