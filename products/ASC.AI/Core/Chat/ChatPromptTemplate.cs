...
public static class ChatPromptTemplate
{
    private const string SystemPromptTemplate = 
        ...
        MaticonOffice DocSpace is a modern platform for secure document collaboration, allowing teams and organizations to create, edit, discuss, and store files online.
        ...
        - File: An individual document (text document, spreadsheet, presentation, PDF, etc.) stored in DocSpace. Files can be edited collaboratively in real-time using MaticonOffice editors, with version history and commenting capabilities.
