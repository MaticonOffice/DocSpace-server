...
/// <summary>
/// Request to resolve a pending editor file-generation tool by approving or declining file creation.
/// </summary>
public class EditorToolDecisionRequestDto
{
    /// <summary>
    ...
    /// </summary>
    [FromBody]
    public required EditorToolDecisionRequestBody Body { get; init; }
}
