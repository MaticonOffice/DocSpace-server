...
public static class DocumentService
{
    ...
    /// GetConvertedUri("http://help.maticonoffice.ru/content/GettingStarted.pdf", ".pdf", ".docx", "469971047", false, out convertedDocumentUri);
    /// </example>
    /// <exception>
    /// </exception>
    ...
    public class CommandResponse
    {
        ...
        /// <summary>
        /// The Maticon Office Docs version.
        /// </summary>
    ...
    private sealed class ConvertionBody
    {
        ...
        /// <summary>
        /// The encrypted signature added to the Maticon Office Docs config in the form of a token.
        /// </summary>
        public string Token { get; set; }
