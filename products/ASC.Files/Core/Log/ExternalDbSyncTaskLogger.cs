...
internal static partial class ExternalDbSyncTaskLogger
{
    [LoggerMessage(LogLevel.Information, "ExternalDbSyncTask: started for room {roomId}.")]
    public static partial void InfoSyncStarted(this ILogger<ExternalDbSyncTask> logger, int roomId);

    [LoggerMessage(LogLevel.Information, "ExternalDbSyncTask: room {roomId} — {processed}/{total} forms synced.")]
    public static partial void InfoSyncProgress(this ILogger<ExternalDbSyncTask> logger, int roomId, int processed, int total);
