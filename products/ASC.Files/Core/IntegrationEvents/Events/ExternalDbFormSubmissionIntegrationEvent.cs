...
[ProtoContract]
public record ExternalDbFormSubmissionIntegrationEvent : IntegrationEvent
{
    private ExternalDbFormSubmissionIntegrationEvent() : base() { }

    public ExternalDbFormSubmissionIntegrationEvent(
        Guid createBy,
        int tenantId,
        int originalFormId,
