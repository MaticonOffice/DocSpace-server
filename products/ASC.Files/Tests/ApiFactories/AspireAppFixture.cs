...
public class AspireAppFixture : IAsyncLifetime
{
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        const string maticonofficeFiles = "maticonoffice-files";
        const string maticonofficePeople = "maticonoffice-people";
        const string maticonofficeWebApi = "maticonoffice-web-api";

        var waitForFiles = resourceNotifications.WaitForResourceHealthyAsync(maticonofficeFiles);
        var waitForPeople = resourceNotifications.WaitForResourceHealthyAsync(maticonofficePeople);
        var waitForApi = resourceNotifications.WaitForResourceHealthyAsync(maticonofficeWebApi);
        ...
        FilesHttpClient = CreateHttpClientNoCookies(maticonofficeFiles);
        PeopleHttpClient = CreateHttpClientNoCookies(maticonofficePeople);
        WebApiHttpClient = CreateHttpClientNoCookies(maticonofficeWebApi);
