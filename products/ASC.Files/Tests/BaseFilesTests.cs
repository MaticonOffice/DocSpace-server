...
public partial class BaseFilesTests
{
    ...
    public static readonly string TestConnection = string.Format("Server=localhost;Database=maticonoffice_test.{0};User ID=root;Password=root;Pooling=true;Character Set=utf8;AutoEnlist=false;SSL Mode=none;AllowPublicKeyRetrieval=True", DateTime.Now.Ticks);
