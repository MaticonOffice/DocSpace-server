...
namespace ASC.Files.Extensions;

public static class FilesServerServiceExtensions
{
    public static IServiceCollection AddFilesServerServices(
    ...
    public static IApplicationBuilder UseFilesServerMiddleware(this IApplicationBuilder app)
    {
        app.MapWhen(
