...
public class AspireAppFixture : IAsyncLifetime
{
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        await resourceNotifications.WaitForResourceHealthyAsync("maticonoffice-people");
        await resourceNotifications.WaitForResourceHealthyAsync("maticonoffice-web-api");
        ...
        PeopleHttpClient = CreateHttpClientNoCookies("maticonoffice-people");
        WebApiHttpClient = CreateHttpClientNoCookies("maticonoffice-web-api");
