    ...
    DisplayUserSettingsHelper displayUserSettingsHelper)
{
        ...
        bool updateExising = false)
    {
        ...
        {
            if (userInfo.ActivationStatus != EmployeeActivationStatus.AutoGenerated)
            {
    ...
    public async Task<string> SendUserPasswordAsync(string email)
    {
        ...
        {
            throw new ArgumentException(nameof(email), Resource.ErrorNotCorrectEmail);
        }
        ...
        if (userInfo.ActivationStatus == EmployeeActivationStatus.AutoGenerated)
        {
            return Resource.CouldNotRecoverPasswordForAutoGeneratedEmail;
        }
