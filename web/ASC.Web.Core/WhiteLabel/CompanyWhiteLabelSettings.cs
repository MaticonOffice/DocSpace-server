...
public class CompanyWhiteLabelSettingsWrapper
{
    ...
    /// </summary>
    /// <example>{"companyName": "MATICONOFFICE", "site": "https://www.maticonoffice.ru", "email": "support@maticonoffice.ru", "address": "Office 1840, Premises 4/45, 12 Presnenskaya Embankment, Moscow, 123112, Russia", "phone": "+7 843 2271372", "isLicensor": true}</example>
...
public class CompanyWhiteLabelSettings : ISettings<CompanyWhiteLabelSettings>
{
    ...
    /// The company site.
    /// </summary>
    /// <example>https://www.maticonoffice.ru</example>
    [Url]
    [StringLength(255)]
    ...
    /// </summary>
    /// <example>support@maticonoffice.ru</example>
    [EmailAddress]
    [StringLength(255)]
    ...
    /// The company address.
    /// </summary>
    /// <example>Office 1840, Premises 4/45, 12 Presnenskaya Embankment, Moscow, 123112, Russia</example>
    [StringLength(255)]
