...
namespace ASC.Web.Core.PublicResources {
    ...
    public class Resource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to allow your users to sign in to MATICONOFFICE using Apple ID. {0}Go to Apple Developers Portal and create a new app MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to connect your Box account to the Documents module. You’ll be able to manage, edit, and share files from Box with MATICONOFFICE users. {0}Sign in to your account on the Box developers page and create a new app for MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Use this app to enable two-factor authentication with Clickatell service. {0}Sign in to your SMS Platform account and create a new integration for MATICONOFFICE. Copy an apiKey and insert it below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to digitally sign documents using DocuSign. {0}Go to your DocuSign Admin Console and add MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to connect your Dropbox account to the Documents module. You’ll be able to manage, edit, and share files from Dropbox with MATICONOFFICE users. {0}Sign in to your account on the Dropbox Developers website and create a new app for MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to create bibliographies in MATICONOFFICE editors. {0}Go to the EasyBib signup page and fill in the form to add MATICONOFFICE integration. After you get an app key, paste it below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to allow your users to sign in to MATICONOFFICE using Facebook and link their customers’ Facebook accounts to the CRM module. {0}Go to Facebook Developers Portal and create a new app MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to allow your users to receive notifications about the messages even offline. {0}Go to Firebase console and add a new project for MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Connect Google Cloud Storage service to backup and store data from your portal. {0}Go to Google Cloud Platform Console and create a new service account for MATICONOFFICE. Paste the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to allow your users to sign in to MATICONOFFICE using their LinkedIn accounts. {0}Go to the LinkedIn Developers website and create a new app MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to allow your users to sign in to MATICONOFFICE using Microsoft. {0}Go to Microsoft Azure and create a new app MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Connect Amazon AWS S3 to backup and store data from your portal. {0}Go to the AWS Management Console and create access keys for MATICONOFFICE. Paste the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to connect your OneDrive account to the Documents module. You’ll be able to manage, edit, and share files from OneDrive with MATICONOFFICE users. {0}Sign in to your Microsoft Azure account and create a new app for MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to allow your users to sign in to MATICONOFFICE using their Twitter and link their customers’ Twitter accounts to the CRM module. {0}Go to Twitter Developers Portal and create a new app MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable the application to easily publish documents to your WordPress website. {0}On the Wordpress Developers page, create a new app for MATICONOFFICE integration. Paste the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to add new portal users from your Yahoo contact list. {0}Go to the Create Application page in the Yahoo Developer Network and create a new app for MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable this app to allow your users to sign in to MATICONOFFICE using their Zoom accounts. {0}Go to the Zoom Developers website and create a new app MATICONOFFICE integration. Insert the data you received below:.
        /// </summary>
