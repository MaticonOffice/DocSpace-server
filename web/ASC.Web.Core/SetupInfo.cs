...
public class SetupInfo
{
    ...
    public string MaticonSiteRedirect { get; private set; }
    ...
    public SetupInfo(IConfiguration configuration)
    {
        ...
        MetaImageURL = GetAppSettings("web.meta-image-url", "https://download.maticonoffice.ru/assets/fb/fb_icon_325x325.jpg");
        ...
        DownloadForDesktopUrl = GetAppSettings("web.download.for.desktop.url", "https://www.maticonoffice.ru/desktop.aspx");
        DownloadForIosDocuments = GetAppSettings("web.download.for.ios.doc", "https://itunes.apple.com/app/maticonoffice-documents/id944896972");
        DownloadForIosProjects = GetAppSettings("web.download.for.ios.proj", "https://itunes.apple.com/app/maticonoffice-projects/id1353395928?mt=8");
        DownloadForAndroidDocuments = GetAppSettings("web.download.for.android.doc", "https://play.google.com/store/apps/details?id=ru.maticonoffice.documents");
        ...
        MaticonSiteRedirect = GetAppSettings("web:maticon-site", string.Empty);
        ...
        SalesEmail = GetAppSettings("web.payment.email", "sales@maticonoffice.ru");
        ...
        TfaAppSender = GetAppSettings("web.tfaapp.backup.title", "MATICONOFFICE");
