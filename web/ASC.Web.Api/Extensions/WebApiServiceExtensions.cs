...
namespace ASC.Web.Api.Extensions;
...
public static class WebApiServiceExtensions
{
    ...
    {
        if (!configuration.GetValue<bool>("disableLdapNotifyService"))
        {
        ...
        services.AddActivePassiveHostedService<NotifySchedulerService>(configuration, "WebApiNotifySchedulerService");
