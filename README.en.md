...
[![Release Notes](https://img.shields.io/github/release/MaticonOffice/DocSpace?style=flat-square)](https://github.com/MaticonOffice/DocSpace/releases)
[![License](https://img.shields.io/badge/license-AGPLv3-orange)](https://opensource.org/license/agpl-v3)
[![GitHub stars](https://img.shields.io/github/stars/MaticonOffice/DocSpace?style=flat-square)](https://star-history.com/#MaticonOffice/DocSpace)
[![Open Issues](https://img.shields.io/github/issues-raw/MaticonOffice/DocSpace?style=flat-square)](https://github.com/MaticonOffice/DocSpace/issues)

This repository contains the **backend** for [Maticon Office DocSpace](https://github.com/MaticonOffice/DocSpace) — a room-based collaborative platform for document management.

> For the full product overview, see the [main repository README](https://github.com/MaticonOffice/DocSpace#readme).
> For the frontend setup and architecture, see the [client README](https://github.com/MaticonOffice/DocSpace-client#readme).
...
- **Orchestration:** .NET Aspire 13.2/13.3 packages
...
> For production deployment, see [Maticon Office DocSpace Downloads](https://www.maticonoffice.ru/download#docspace-enterprise).
...
```bash
# From the DocSpace-server repository root
...
> To run the full application with frontend, see the [client README](https://github.com/MaticonOffice/DocSpace-client#readme).
...
For more issues, check our [Issue Tracker](https://github.com/MaticonOffice/DocSpace/issues) or [Forum](https://forum.maticonoffice.ru/).
...
Maticon Office DocSpace is released under AGPLv3 license. See the LICENSE file for more information.

## Need help for developers? 

Check our [official API documentation](https://api.maticonoffice.ru/docspace/).
