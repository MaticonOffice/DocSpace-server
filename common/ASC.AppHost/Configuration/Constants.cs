...
public static class Constants
{
    ...
    public const string OpenRestyContainer = "maticonoffice-openresty";
    public const string EditorsContainer = "maticonoffice-editors";
    public const string OpensearchContainer = "opensearch";
    public const string SocketIoContainer = "maticonoffice-socketIO";
    public const string DocSpaceMcpContainer = "maticonoffice-docspace-mcp";
    public const string OtelCollectorContainer = "maticonoffice-otel-collector";

    public const string IdentityRegistrationContainer = "maticonoffice-identity-registration";
    public const string IdentityAuthorizationContainer = "maticonoffice-identity-authorization";
}
