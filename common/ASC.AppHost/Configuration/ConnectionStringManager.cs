...
#pragma warning restore ASPIRECERTIFICATES001
    ...
    {
        McpResource = builder
            .AddContainer(Constants.DocSpaceMcpContainer, "maticonoffice/docspace-mcp")
    ...
    public ConnectionStringManager AddEditors()
    {
        ...
        {
            "enterprise" => forTesting ? "maticonoffice/4testing-documentserver-ee" : "maticonoffice/documentserver-ee",
            "developer" => forTesting ? "maticonoffice/4testing-documentserver-de" : "maticonoffice/documentserver-de",
            _ => forTesting ? "maticonoffice/4testing-documentserver" : "maticonoffice/documentserver"
        };
        ...
        EditorResource = builder
            ...
            .WithBindMount(Path.Combine(basePath, "Data"), "/var/www/maticonoffice/Data");
