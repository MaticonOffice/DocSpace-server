...
{
    public static IServiceCollection AddNotifyServices(
    ...
    public static async Task SubscribeNotifyEvents(this IEventBus eventBus)
    {
        await Task.WhenAll(
            eventBus.SubscribeAsync<NotifyInvokeSendMethodRequestedIntegrationEvent,
                NotifyInvokeSendMethodRequestedIntegrationEventHandler>(),
            eventBus.SubscribeAsync<NotifySendMessageRequestedIntegrationEvent,
                NotifySendMessageRequestedIntegrationEventHandler>());
    }
}
