...
internal static partial class PortalControllerLogger
{
    ...
    [LoggerMessage(LogLevel.Error, "Tenant not found")]
    public static partial void ErrorTenantNotFound(this ILogger logger);

    [LoggerMessage(LogLevel.Error, "GetPortalsAsync failed")]
    public static partial void ErrorGetPortals(this ILogger logger, Exception exception);
