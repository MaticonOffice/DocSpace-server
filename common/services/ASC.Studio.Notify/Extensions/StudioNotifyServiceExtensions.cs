...
public static class StudioNotifyServiceExtensions
{
    public static IServiceCollection AddStudioNotifyServices(
    ...
    public static async Task SubscribeStudioNotifyEvents(this IEventBus eventBus)
    {
        await eventBus.SubscribeAsync<NotifyItemIntegrationEvent,
            NotifyItemIntegrationEventHandler>();
    }
}
