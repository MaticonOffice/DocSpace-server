...
{
    Task WriteEntryAsync(string tarKey, Stream stream, Func<Task> action);
    Task WriteEntryAsync(string tarKey, string domain, string path, IDataStore store, Func<Task> action);
    bool NeedUpload { get; }
    string Hash { get; }
