...
namespace ASC.Core.Common.Tests
{
    ...
    public class HostedSolutionTest
    {
        ...
        public void RegionsTest()
        {
            ...
            //var t1 = regionSerice.GetTenant("maticonoffice.ru", 50001);
            //Assert.AreEqual("alias_test2.maticonoffice.ru", t1.GetTenantDomain(null));

            //var t2 = regionSerice.GetTenant("maticonoffice.ru", 50001);
            //Assert.AreEqual("tscherb.maticonoffice.ru", t2.GetTenantDomain(null));
        }
    }
}
#endif
