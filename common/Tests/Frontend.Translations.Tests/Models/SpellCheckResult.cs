...
public class SpellCheckResult
{
    ...
    {
        "maticonoffice.ru", "maticonoffice.ru", "Office Open XML", "Maticon Office Desktop Editors",
        "Maticon Office Desktop", "Maticon Office Documents", "Google Drive", "Twitter", "Facebook", "LinkedIn", "Google",
        "Yandex", "Yandex.Disk", "Dropbox","OneDrive","MATICONOFFICE", "DocuSign", "e-mail",
