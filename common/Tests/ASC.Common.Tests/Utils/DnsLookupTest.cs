...
namespace ASC.Common.Tests.Utils
{
    ...
    public class DnsLookupTest
    {
        ...
        {
            const string domain = "maticonoffice.ru";
        ...
        {
            const string domain = "maticonoffice.ru";
            const string mx_record = "mx1.maticonoffice.ru";
        ...
        {
            const string domain = "maticonoffice.ru";
            const string txt_record = "v=spf1 a mx mx:avsmedia.net a:smtp1.uservoice.com a:qamail.maticonoffice.ru include:amazonses.com -all";
        ...
        public void GetPtr()
        {
            const string domain = "mx1.maticonoffice.ru";
