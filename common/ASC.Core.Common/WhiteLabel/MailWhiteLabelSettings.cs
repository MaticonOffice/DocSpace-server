...
public class MailWhiteLabelSettingsHelper
{
    ...
    public string DefaultMailSupportUrl
    {
        get
        {
            ...
            return !string.IsNullOrEmpty(url) ? url : "http://support.maticonoffice.ru";
        }
    }
    ...
    public string DefaultMailSupportEmail
    {
        get
        {
            ...
            return !string.IsNullOrEmpty(email) ? email : "support@maticonoffice.ru";
        }
    }
    ...
    public string DefaultMailSalesEmail
    {
        get
        {
            ...
            return !string.IsNullOrEmpty(email) ? email : "sales@maticonoffice.ru";
        }
    }
    ...
    public string DefaultMailDemoUrl
    {
        get
        {
            ...
            return !string.IsNullOrEmpty(url) ? url : "http://www.maticonoffice.ru/demo-order.aspx";
        }
    }
    ...
    public string DefaultMailSiteUrl
    {
        get
        {
            var url = _configuration["web:maticon-site"];

            return !string.IsNullOrEmpty(url) ? url : "http://www.maticonoffice.ru";
        }
    }
}
