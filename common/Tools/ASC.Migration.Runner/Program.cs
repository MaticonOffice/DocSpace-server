...
foreach (var providerInfo in providersInfo.Providers)
{
    ...
    migrationCreator.RunApplyMigrations(AppContext.BaseDirectory, providerInfo, providersInfo.MaticonsiteProviders.SingleOrDefault(q => q.Provider == providerInfo.Provider), configurationInfo);
}
