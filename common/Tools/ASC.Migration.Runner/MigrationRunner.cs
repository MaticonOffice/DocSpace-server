...
public class MigrationRunner
{
    ...
    public void RunApplyMigrations(string path, ProviderInfo dbProvider, ProviderInfo maticonsiteProvider, ConfigurationInfo configurationInfo)
    {

        var migrationContext = _dbContextActivator.CreateInstance(typeof(MigrationContext), dbProvider);
        migrationContext.Database.Migrate();

        var maticonContext = _dbContextActivator.CreateInstance(typeof(MaticonSiteContext), maticonsiteProvider);
        maticonContext.Database.Migrate();
