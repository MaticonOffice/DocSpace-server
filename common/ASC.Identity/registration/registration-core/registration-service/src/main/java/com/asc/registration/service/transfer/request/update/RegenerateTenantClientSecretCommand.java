...
/**
 * RegenerateTenantClientSecretCommand is a Data Transfer Object (DTO) used to regenerate the secret
 * of a tenant client. It contains validation annotations to ensure data integrity.
 */
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class RegenerateTenantClientSecretCommand {
