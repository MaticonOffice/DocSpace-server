...
/** Represents an event indicating that a {@link Scope} has been deleted. */
public class ScopeDeletedEvent extends ScopeEvent {
  /**
   * Constructs a ScopeDeletedEvent instance.
   *
   ...
   */
  public ScopeDeletedEvent(Audit audit, Scope scope, ZonedDateTime eventAt) {
