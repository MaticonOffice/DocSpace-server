...
public class OCMigratingUser : MigratingUser<OCMigratingContacts, OCMigratingCalendar, OCMigratingFiles, OCMigratingMail>
{
    ...
    {
        ModulesList.Add(new MigrationModules(ModuleName, MigrationResource.MaticonofficeModuleNamePeople));
        ...
        {
            ModulesList.Add(new MigrationModules(MigratingContacts.ModuleName, MigrationResource.MaticonofficeModuleNameMail));
        }
        ...
        {
            ModulesList.Add(new MigrationModules(MigratingCalendar.ModuleName, MigrationResource.MaticonofficeModuleNameCalendar));
        }
        ...
        {
            ModulesList.Add(new MigrationModules(MigratingFiles.ModuleName, MigrationResource.MaticonofficeModuleNameDocuments));
        }
